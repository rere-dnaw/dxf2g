...
class ReloadError(IOError):
    ...
    """
    def __init__(self):
        IOError.__init__(self, 'reload failed, file_name is not set.')
...
class ConfigObj(Section):
    ...
    def _load(self, infile, configspec):
        if isinstance(infile, six.string_types):
            ...
            if os.path.isfile(infile):
                ...
                raise IOError('Config file not found: "%s".' % self.file_name)
            else:
                # file doesn't already exist
                if self.create_empty:
                    # this is a good test that the file_name specified
            ...
            raise TypeError('infile must be a file_name, file like object, or list of lines.')
    ...
    def write(self, outfile=None, section=None):
        ...
        if (self.file_name is None) and (outfile is None):
        ...
        if outfile is not None:
            ...
            with open(self.file_name, 'wb') as h:
    ...
    def reload(self):
        ...
        a file_name attribute pointing to a file.
        """
        if not isinstance(self.file_name, six.string_types):
            raise ReloadError()
        ...
        self._load(file_name, configspec)
