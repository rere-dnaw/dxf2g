...
class ReadDXF():
    ...
    def __init__(self, file_name=None):
        ...
        str_ = self.Read_File(file_name) #read file into str_ list
    ...
    def Read_File(self, file_name):
        ...
        for e in encodings:
            try:
                file_ = open(file_name, 'r', encoding=e)
    ...
    def Get_Line_Pairs(self, string):
        ...
        try:
            ...
            QMessageBox.warning(g.window, "Warning reading linepairs", message)
...
#                 logger.debug(geo[geo_nr])
    ...
    def App_Cont_or_Calc_IntPts(self, geo=None, cont=None):
        ...
        if warning:
            QMessageBox.warning(g.window, "Short Elements",
                                "Length of some Elements too short!"
