...
class Shape(object):
    ...
    def isDirectionOfGeosCCW(self, geos):
        ...
        if summe == 0:  # inconclusive
            logger.debug("Shoelace method cannot (directly) be applied to this shape")
    ...
    def Write_GCode(self, PostPro):
        ...
        to export
        """
        #if g.config.machine_type == 'drag_knife':   #rw
        #    return self.Write_GCode_Drag_Knife(PostPro)   #rw
